...
We designed the platform around a microservices architecture, with each core function — authentication, data API, user preferences, and export — built as an independent, containerised service. This gave the client flexibility to deploy on-premise, in the cloud, or in a hybrid setup, and meant their in-house team could evolve individual services without risk to the wider system. The front end was built in Svelte, the API layer in .NET, and the whole platform orchestrated with Kubernetes.
